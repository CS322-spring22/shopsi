...
var resultManTop = document.getElementById("resultsManTop")
var resultWomanTop = document.getElementById("resultsWomanTop")
var resultManBottom = document.getElementById("resultsManBottom")
var resultWomanBottom = document.getElementById("resultsWomanBottom")
...
function getResults() {
    if (getMeasure['Bust/Chest'] == 0 && getMeasure['Neckline'] == 0 && getMeasure['Waist'] == 0 && getMeasure['Low Hip'] == 0 && getMeasure['Arm Length'] == 0 && getMeasure['Inseam'] == 0) {
        resultManTop.innerHTML = 'Please provide your measurements<br> Click the \"Edit"\ button'
    } else if (gender == 'male'){
...
function getManTopSizeRecommend() {
    if (
        ...
        console.log("XS");
        resultManTop.innerHTML = 'Your top men\'s size recommend: <div id="size">Extra Small (XS)</div>'
    } else if (
        ...
        console.log("S");
        resultManTop.innerHTML = 'Your top men\'s size recommend: <div id="size">Small (S)</div>'
    } else if (
        ...
        console.log("M");
        resultManTop.innerHTML = 'Your top men\'s size recommend: <div id="size">Medium (M)</div>'
    } else if (
        ...
        console.log("L")
        resultManTop.innerHTML = 'Your top men\'s size recommend: <div id="size"> Large (L)</div>'
    } else if (
        ...
        console.log("XL");
        resultManTop.innerHTML = 'Your top men\'s size recommend: <div id="size">Extra Large (XL)</div>'
    } else if (
        ...
        console.log("XXL");
        resultManTop.innerHTML = 'Your top men\'s size recommend: <div id="size">2 Extra Large (XXL)</div>'
    } else if (
        ...
        console.log("XXXL");
        resultManTop.innerHTML = 'Your top men\'s size recommend is <div id="size">3 Extra Large (XXXL)</div>'
    } else {
        console.log('Input the correct size');
        resultManTop.innerHTML = 'Unable to provide your size, please edit your measurements'
    }
}
...
function getWomanTopSizeRecommend() {
    if (
        ...
        console.log("XXS")
        resultWomanTop.innerHTML = 'Your top women\'s size recommend: <div id="size">2 Extra Small (XXS)</div>'
    } else if (
        ...
        console.log("XS");
        resultWomanTop.innerHTML = 'Your top women\'s size recommend: <div id="size">Extra Small (XS)</div>'
    } else if (
        ...
        console.log("S");
        resultWomanTop.innerHTML = 'Your top women\'s size recommend: <div id="size">Small (S)</div>'
    } else if (
        ...
        console.log("M");
        resultWomanTop.innerHTML = 'Your top women\'s size recommend: <div id="size">Medium (M)</div>'
    } else if (
        ...
        console.log("L")
        resultWomanTop.innerHTML = 'Your top women\'s size recommend: <div id="size">Large (L)</div>'
    } else if (
        ...
        console.log("XL");
        resultWomanTop.innerHTML = 'Your top women\'s size recommend: <div id="size">Extra Large (XL)</div>'
    } else if (
        ...
        console.log("XXL");
        resultWomanTop.innerHTML = 'Your top women\'s size recommend: <div id="size">2 Extra Large (XXL)</div>'
    } else if (
        ...
        console.log("XXXL");
        resultWomanTop.innerHTML = 'Your top women\'s size recommend is <div id="size">3 Extra Large (XXXL)</div>'
    } else if (
        ...
        console.log("4XL");
        resultWomanTop.innerHTML = 'Your top women\'s size recommend is <div id="size">4 Extra Large (4XL)</div>'
    } else {
        console.log('Input the correct size');
        resultWomanTop.innerHTML = 'Unable to provide your size, please edit your measurements'
    }
}
...
function getManBottomSizeRecommend() {
    if (
        ...
        console.log("XS")
        resultManBottom.innerHTML = 'Your bottom men\'s size recommend: <div id="size">Extra Small (XS)</div>'
    } else if (
        between(getMeasure['Waist'], 74, 82) ||
        ...
        console.log("S")
        resultManBottom.innerHTML = 'Your bottom men\'s size recommend: <div id="size">Small (S)</div>'
    } else if (
        between(getMeasure['Waist'], 82, 90) ||
        between(getMeasure['Low Hip'], 97, 103) ||
        ...
        console.log("M")
        resultManBottom.innerHTML = 'Your bottom men\'s size recommend: <div id="size">Medium (M)</div>'
    } else if (
        between(getMeasure['Waist'], 90, 98) ||
        ...
        console.log("L")
        resultManBottom.innerHTML = 'Your bottom men\'s size recommend: <div id="size">Large (L)</div>'
    } else if (
        between(getMeasure['Waist'], 98, 107) ||
        ...
        console.log("XL")
        resultManBottom.innerHTML = 'Your bottom men\'s size recommend: <div id="size">Extra Large (XL)</div>'
    } else if (
        between(getMeasure['Waist'], 107, 116) ||
        ...
        console.log("XXL")
        resultManBottom.innerHTML = 'Your bottom men\'s size recommend: <div id="size">2 Extra Large (XXL)</div>'
    } else if (
        between(getMeasure['Waist'], 116, 125) ||
        ...
        console.log("3XL")
        resultManBottom.innerHTML = 'Your bottom men\'s size recommend: <div id="size">3 Extra Large (XXXL)</div>'
    } else {
        console.log('Input the correct size');
        resultManBottom.innerHTML = 'Unable to provide your size, please edit your measurements'
    }
}
...
function getWomanBottomSizeRecommend() {
    if (
        ...
        console.log("XXS")
        resultWomanBottom.innerHTML = 'Your bottom women\'s size recommend: <div id="size">2 Extra Small (XXS)</div>'
    } else if (
        between(getMeasure['Waist'], 62, 66) ||
        between(getMeasure['Low Hip'], 86, 90) ||
        between(getMeasure['Inseam'], 78, 78)
        ...
        console.log("XS")
        resultWomanBottom.innerHTML = 'Your bottom women\'s size recommend: <div id="size">Extra Small (XS)</div>'
    } else if (
        between(getMeasure['Waist'], 66, 74) ||
        between(getMeasure['Low Hip'], 90, 97) ||
        between(getMeasure['Inseam'], 78, 78)
        ...
        console.log("S")
        resultWomanBottom.innerHTML = 'Your bottom women\'s size recommend: <div id="size">Small (S)</div>'
    } else if (
        between(getMeasure['Waist'], 74, 82) ||
        between(getMeasure['Low Hip'], 97, 103) ||
        between(getMeasure['Inseam'], 78, 78)
        ...
        console.log("M")
        resultWomanBottom.innerHTML = 'Your bottom women\'s size recommend: <div id="size">Medium (M)</div>'
    } else if (
        between(getMeasure['Waist'], 82, 93) ||
        between(getMeasure['Low Hip'], 103, 110) ||
        between(getMeasure['Inseam'], 78, 78)
        ...
        console.log("L")
        resultWomanBottom.innerHTML = 'Your bottom women\'s size recommend: <div id="size">Large (L)</div>'
    } else if (
        between(getMeasure['Waist'], 93, 105) ||
        between(getMeasure['Low Hip'], 110, 120) ||
        between(getMeasure['Inseam'], 78, 78)
        ...
        console.log("XL")
        resultWomanBottom.innerHTML = 'Your bottom women\'s size recommend: <div id="size">Extra Large (XL)</div>'
    } else if (
        between(getMeasure['Waist'], 105, 117) ||
        between(getMeasure['Low Hip'], 120, 131) ||
        between(getMeasure['Inseam'], 78, 78)
        ...
        console.log("XXL")
        resultWomanBottom.innerHTML = 'Your bottom women\'s size recommend: <div id="size">2 Extra Large (XXL)</div>'
    } else if (
        between(getMeasure['Waist'], 117, 131) ||
        between(getMeasure['Low Hip'], 131, 143) ||
        between(getMeasure['Inseam'], 78, 78)
        ...
        console.log("3XL")
        resultWomanBottom.innerHTML = 'Your bottom women\'s size recommend: <div id="size">3 Extra Large (XXXL)</div>'
    } else if (
        between(getMeasure['Waist'], 131, 145) ||
        between(getMeasure['Low Hip'], 143, 155) ||
        between(getMeasure['Inseam'], 78, 78)
        ...
        console.log("4XL")
        resultWomanBottom.innerHTML = 'Your bottom women\'s size recommend: <div id="size">4 Extra Large (4XL)</div>'
    } else {
        console.log('Input the correct size');
        resultWomanBottom.innerHTML = 'Unable to provide your size, please edit your measurements'
    }
}